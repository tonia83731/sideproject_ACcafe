    ...
    <section className="banner">
      <div className="banner-container">
        <div className="main-banner">
          ...
          <a href="/menu" className="main-btn btn default-btn">Go to Menu</a>
          <div className="background-white"></div>
        </div>
        <div className="sub-banner left-top-banner">
          <h5 className="sub-title">Valentines Day Special Deal!</h5>
          <a href="/news" className="left-top-btn sub-btn btn default-btn">More</a>
        ...
        <div className="sub-banner right-down-banner">
          ...
          <a href="/news" className="right-down-btn sub-btn btn default-btn">More</a>
          <div className="sub-background-white"></div>
        </div>
      </div>
    </section>
